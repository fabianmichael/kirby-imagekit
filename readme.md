...
|:--------------------|:--------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `imagekit.license`    | `''`          | Enter your license code here, once your site goes live.<br>[<img src="https://fabianmichael.de/shared/buy-imagekit.png" width="142" height="48" alt="Buy a license">](http://sites.fastspring.com/fabianmichael/product/imagekit)                                                                                                                                                                       |
